                                ...
                                datasets: [
                                    {
                                        ...
                                        borderWidth: 2,
                                        pointBackgroundColor: mUtil.getColor(
                                            "brand"
                                        ),
                                        backgroundColor: mUtil.getColor(
                                            "accent"
                                        ),
                ...
                (function() {
                    function e(e, a, r) {
                        var o = "",
                            l = "";
                        a - e < 100
                            ? ((o = "Today:"), (l = e.format("MMM D")))
                            : "Yesterday" == r
                            ? ((o = "Yesterday:"), (l = e.format("MMM D")))
                            : (l =
                                  e.format("MMM D") +
                                  " - " +
                                  a.format("MMM D")),
                    ...
                    $(".m_datatable").mDatatable({
                        data: {
                            ...
                            source: {
                                read: {
                                    url:
                                        "http://keenthemes.com/metronic/preview/inc/api/datatables/demos/default.php"
                                }
                            },
                            pageSize: 20,
                                ...
                                events: [
                                    {
                                        ...
                                        className:
                                            "m-fc-event--light m-fc-event--solid-warning"
                                    },
                                    {
                                        title: "Conference",
                                        description:
                                    ...
                                    },
                                    {
                                        ...
                                        className:
                                            "m-fc-event--light  m-fc-event--solid-danger"
                                    },
                                    {
                                        title: "All Day Event",
                                        ...
                                        description:
                                            "Lorem ipsum dolor sit incid idunt ut",
                                        className:
                                            "m-fc-event--danger m-fc-event--solid-focus"
                                    },
                                    {
                                        title: "Reporting",
                                        description:
                                    ...
                                    },
                                    {
                                        ...
                                        className:
                                            "m-fc-event--info m-fc-event--solid-accent",
                                        description:
                                    ...
                                    },
                                    {
                                        ...
                                        start: moment("2017-09-24"),
                                        className:
                                            "m-fc-event--light m-fc-event--solid-focus",
                                        description:
                                            "Lorem ipsum dolor sit amet, conse ctetur"
                                    },
                                    {
