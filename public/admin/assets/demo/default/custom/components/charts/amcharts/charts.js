var amChartsChartsDemo = (function() {
    var e = function() {
        ...
        l = function() {
            function e() {
                a.zoomToIndexes(
                    a.dataProvider.length - 40,
                    a.dataProvider.length - 1
                );
            }
        ...
        s = function() {
            ...
            var a = (function() {
                    ...
                    for (var t = 0; t < 1e3; t++) {
                        ...
                        var r =
                            Math.round(Math.random() * (40 + t / 5)) + 20 + t;
                ...
                t = AmCharts.makeChart("m_amcharts_7", {
                    ...
                    dataProvider: a,
                    valueAxes: [
                        { axisAlpha: 0.2, dashLength: 1, position: "left" }
                    ],
                    mouseWheelZoomEnabled: !0,
                    graphs: [
                        {
