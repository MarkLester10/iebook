...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    ...
    <head>
        ...
        <title>Subscription Reminder</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
    ...
    <!--[if mso]>  -->
        <style>
            * {
            ...
            /* changes padding left and right for contents on tablet portrait and up */
                ...
                <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto; padding: 40px;">
                    ...
                    <tr>
                        <td style="background-color: #ffffff;">
                            <img src="{{ asset('imgs/siteicons/subscription-reminder.jpg') }}" width="680" height="" alt="Subscription Reminder" border="0" style="width: 100%; height: auto; display: block; object-fit: contain;" class="g-img">
                        </td>
                    </tr>
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="font-size: 14px; text-align: left;">
                                            <tr>
                                                <td valign="top" style="width:100%;">
                                                    ...
                                                    <p class="text--black">Thanks for using our service - we love having you as our customer. Your subscription plan will expire in 3 days, so we thought we’d check in.</p> <br>
                                                    <p class="text--black">If you want to continue taking advantage of our features and retain all your data and preferences, you can easily renew by going to <strong><em><a href="{{ route('account.upgrade.form') }}">this link</a></em></strong>.
                                                    </p><br>
                                                    <p class="text--black"> If there’s any issue we can help with, please contact our support team at industrialengineeringbook@gmail.com. <br> You can also find us on live chat right from our website.</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                    ...
                    <tr>
                        <td align="left" valign="top" style="font-size:0; background-color: #ffffff;" class="td__content td__closing_msg">
                            <p class="text--black"> Best Regards, </p>
                        ...
                        <td align="center" valign="top" style="font-size:0; padding: 10px; background-color: #FFFFFF;">
                            <div style="display:inline-block; margin: 0 -1px;" class="">
                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                    <tr>
                                        <td valign="middle">
                                            <p style="margin-bottom: 10px; font-size: 15px; line-height: 30px; color: #000000; text-align: center;"> &copy; {{ date('Y') }} {{ config('app.name') }}. All Rights Reserved.</p>
                                        </td>
                                    </tr>
                                </table>
                            </div>
